                   ...
                   <div class="row d-flex vh-100">
                       <div class="col-md-8 p-4 ikigui m-auto text-center align-items-center">
                           ...
                           <div class="input-group mb-4">
                              ...
                              <input type="email" id="email" name="email" class="form-control ps-2 border-start-0 fs-7 inbg form-control-lg mb-0" placeholder="Enter Email" aria-label="Email" aria-describedby="basic-addon1">
                           </div>
                           <div class="input-group mb-4">
                           ...
                           <button name="login" id="login" class="btn btn-lg fw-bold fs-7 btn-success  w-100">Login</button>
                           </form>
